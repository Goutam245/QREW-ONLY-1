...
import qrewLogo from '@/assets/qrew-only-green-logo.jpg';
          ...
          {bootComplete && (
            <div className="py-8 md:py-12 animate-fade-in">
              <img 
                src={qrewLogo} 
                alt="QREW ONLY" 
                className="w-48 sm:w-64 md:w-80 lg:w-96 h-auto object-contain drop-shadow-[0_0_40px_rgba(0,255,65,0.7)] mx-auto"
              />
            </div>
          )}
